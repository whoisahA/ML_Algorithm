...
In logistic regression, we are trying to model\
the outcome of a binary variable given a linear combination of input features.\
For example, we could try to predict the outcome of an election (win/lose) \
using information about how much money a candidate spent campaigning,\
how much time she/he spent campaigning, etc.
"""
import numpy as np
